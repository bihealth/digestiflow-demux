# -*- coding: utf-8 -*-
"""Convert match_vector.tsv file from cubi-hts_screen.sh
"""
...
def run(args):
    ...
    for lineno, line in enumerate(args.in_file):
        ...
        if not sum(arr):
            num_reads_no_hits += 1
        is_mapped, is_multi, n_genomes = False, False, 0
    ...
    # print results
    print(
        "#hts_screen version 0.1\t#Reads in subset: {num_reads}".format(num_reads=num_reads),
        file=args.out_file,
    )
    print(
        (
